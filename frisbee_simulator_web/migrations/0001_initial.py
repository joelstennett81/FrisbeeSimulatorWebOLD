...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='GameSimulation',
            fields=[
                ('game_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='frisbee_simulator_web.game')),
            ],
            bases=('frisbee_simulator_web.game',),
        ),
        migrations.CreateModel(
            name='TeamInGameSimulation',
            fields=[
                ('tournamentteam_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='frisbee_simulator_web.tournamentteam')),
            ],
            bases=('frisbee_simulator_web.tournamentteam',),
        ),
        migrations.AddField(
