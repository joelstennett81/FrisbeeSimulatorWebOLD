    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('game_type', models.CharField(choices=[('Pool Play', 'Pool Play'), ('Pre-Quarterfinal', 'Pre-Quarterfinal'), ('Quarterfinal', 'Quarterfinal'), ('Semifinal', 'Semifinal'), ('Championship', 'Championship'), ('Third-Place', 'Third-Place'), ('Fifth-Place', 'Fifth-Place'), ('Seventh-Place', 'Seventh-Place')], max_length=50)),
            ],
        ),
        migrations.CreateModel(
            name='Player',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bracket_type', models.CharField(choices=[('Championship', 'Loser'), ('Loser', 'Loser')], max_length=50)),
            ],
        ),
        migrations.CreateModel(
            name='TournamentPool',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bracket', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='frisbee_simulator_web.tournamentbracket')),
                ('pool', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='frisbee_simulator_web.tournamentpool')),
        ...
        migrations.AddField(
            ...
            name='champion',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='frisbee_simulator_web.tournamentteam'),
        ),
        migrations.AddField(
            model_name='tournamentbracket',
            name='teams',
        ...
        migrations.AddField(
            model_name='game',
            name='loser',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='loser_games', to='frisbee_simulator_web.tournamentteam'),
        ),
        migrations.AddField(
            model_name='game',
            name='team_one',
        ...
        migrations.AddField(
            model_name='game',
            name='winner',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='winner_games', to='frisbee_simulator_web.tournamentteam'),
        ),
    ]
